...
.. list-table::
   ...
   * - **Just want to get started?**
     - Follow the verified step-by-step walkthrough in :doc:`guide_usage`
   * - **New to Panobbgo?**
...
4. **Run optimization** (evaluations run in local threads by default; Dask is optional)
...
**Parallel-First**
   Evaluations are dispatched in parallel from the ground up — local threads or processes by default, a Dask cluster optionally.
...
- **API Documentation**: https://haraldschilly.github.io/panobbgo/
- **Agent / contributor notes**: ``AGENTS.md`` and ``TODO.md`` in the repository
