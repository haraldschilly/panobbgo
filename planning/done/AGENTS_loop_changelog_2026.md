# AGENTS.md — self-improvement loop changelog (archived 2026-09-09)

Verbatim copy of the sections removed from `AGENTS.md` in the 2026-09-09
documentation consolidation. They document, flag by flag and dated
"shipped YYYY-MM-DD", how the autonomous self-improvement loop was built
between 2026-05 and 2026-07. The loop is **not currently in use** (the
nightly workflow has been disabled on GitHub since 2026-08-13); its code
(`panobbgo/self_improve.py`, `scripts/self_improve.py`) and tests remain in
the tree. For the current flag reference see `planning/LOOP_REFERENCE.md`;
for the design see `planning/SELF_IMPROVEMENT_LOOP.md`; for the dated log
see `planning/SELF_IMPROVEMENT_LOG.md`.

Original location: `AGENTS.md` lines 284–1335 (loop section) and
1413–1455 ("Self-improvement loop on AOCC") at commit `fac26b8`.
