# Self-improvement log archive — entries before 2026-07-30

Split out of `planning/SELF_IMPROVEMENT_LOG.md` on 2026-08-11. Same
newest-first convention; the cut-off is the 2026-07-30 metric-aware-codify
epoch, when the aocc codify pipeline first worked end to end.
