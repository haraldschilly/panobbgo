# TODO archive — 2026-07-30 to 2026-09-15

Moved out of `TODO.md` verbatim on 2026-09-25, when `TODO.md` was rewritten
as a short list of open work. Findings with numbers are in
`planning/DISCOVERY_2026-09-09.md` (§1–§53); the August loop entries below
concern the nightly self-improvement loop, disabled since 2026-08-13.
