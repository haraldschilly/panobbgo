...
class TestFilterConstraintHandler(PanobbgoTestCase):
    ...
    def test_infeasible_tradeoff(self):
        ...
        p1 = Point(np.array([1.0]), "t1")
        r1 = Result(p1, 100.0, cv_vec=np.array([0.0]))
        ...
        p2 = Point(np.array([2.0]), "t2")
        r2 = Result(p2, 50.0, cv_vec=np.array([10.0]))
        ...
        # Dominated by r2
        p3 = Point(np.array([3.0]), "t3")
        r3 = Result(p3, 50.0, cv_vec=np.array([20.0]))
        ...
        p4 = Point(np.array([4.0]), "t4")
        r4 = Result(p4, 60.0, cv_vec=np.array([5.0]))
    ...
    def test_is_better_preserves_feasibility_preference(self):
        # r1: fx=10, cv=0
        p1 = Point(np.array([1.0]), "t1")
        r1 = Result(p1, 10.0, cv_vec=np.array([0.0]))
        ...
        p2 = Point(np.array([2.0]), "t2")
        r2 = Result(p2, 5.0, cv_vec=np.array([10.0]))
