...
def test_strategy_ucb_execution():
    ...
    strategy = StrategyUCB(problem, max_eval=100, evaluation_method="threaded", testing_mode=True)
...
def test_strategy_thompson_execution():
    ...
    """
    problem = Rosenbrock(dims=2)
    strategy = StrategyThompsonSampling(problem, max_eval=100, evaluation_method="threaded", testing_mode=True)
